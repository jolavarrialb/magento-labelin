...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://shipping-api-sandbox.pitneybowes.com/shippingservices';
    ...
    public function getHostSettings(): array
    {
        return [
            [
                'url' => 'https://shipping-api-sandbox.pitneybowes.com/shippingservices',
                'label' => __('Sandbox'),
            ...
            [
                'url' => 'https://shipping-api.pitneybowes.com/shippingservices',
                'label' => __('Production'),
